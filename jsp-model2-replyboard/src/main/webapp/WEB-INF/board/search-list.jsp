    ...
    <nav aria-label="Page navigation example" class="mt-5 mb-5">
        ...
        <ul class="pagination d-flex justify-content-center">
            <c:if test="${paginationStart!=1}">
                <li class="page-item">
                    <a class="page-link"
                       href="../board/search?page=1&search=${search}&searchWord=${searchWord}" aria-label="Next">
                        <i class="bi bi-chevron-double-left"></i>
                    </a>
                </li>
                <li class="page-item">
                    <a class="page-link" href="../board/search?page=${paginationStart-1}&search=${search}&searchWord=${searchWord}" aria-label="Previous">
            ...
            <c:forEach begin="${paginationStart}" end="${paginationEnd}" step="1" var="page">
                <c:choose>
                  ...
                  <span class="page-link" href="../board/search?page=${page}&search=${search}&searchWord=${searchWord}">
                          ${page}
                  </span>
                        </li>
                    </c:when>
                    <c:otherwise>
                        <c:choose>
                            <c:when test="${param.page ne page}">
                                <li class="page-item">
                                    <a class="page-link" href="../board/search?page=${page}&search=${search}&searchWord=${searchWord}">
                                            ${page}
                                    </a>
                                </li>
                            </c:when>
            ...
            <c:if test="${totalPagination != paginationEnd}">
                <li class="page-item">
                    <a class="page-link"
                       href="../board/search?page=${paginationStart+paginationPerPage}&search=${search}&searchWord=${searchWord}" aria-label="Next">
                        <i class="bi bi-chevron-right"></i>
                    </a>
                </li>
                <li class="page-item">
                    <a class="page-link"
                       href="../board/search?page=${totalPagination}&search=${search}&searchWord=${searchWord}" aria-label="Next">
